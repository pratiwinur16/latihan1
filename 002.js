...
function pairUp(students) {
  ...
  for(var i = 0 ; i < students.length ; i+=2){
    if(students[i+1] !== undefined){                        // contoh var students ['Budi','Badu'] jika students[i] memiliki pasangan
      resultString = students[i] + ' dan ' + students[i+1]
    }else{
      resultString = students[i] + ' dan Instruktur'
    }
